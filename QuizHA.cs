...
while (anzahl < 1)
{
    Console.WriteLine("Die Zahl muss mindestens 1 sein.");
    Console.Write("Wie viele Fragen möchten Sie? (1-5): ");
...
while (anzahl > 5)
{
    Console.WriteLine("Die Zahl darf höchstens 5 sein.");
    Console.Write("Wie viele Fragen möchten Sie? (1-5): ");
    anzahl = Convert.ToInt32(Console.ReadLine());
}
...
while (bonus < 1)
{
    Console.WriteLine("Bitte wählen Sie eine Zahl zwischen 1 und 4.");
